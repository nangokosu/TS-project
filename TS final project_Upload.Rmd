...
final_ts_df['lag_diff_log_AvgElectricityPrices'] = lag(final_ts_df$diff_log_AvgElectricityPrices)
```
...
lag_CPI_Unemployment_AvgElectricityPrices <- lm ( diff_log_CPI ~ diff_log_Unemployment + lag_diff_log_Unemployment + diff_log_AvgElectricityPrices + lag_diff_log_AvgElectricityPrices, data = final_ts_df)
...
lag_PPI_Unemployment_AvgElectricityPrices <- lm ( diff_log_PPI ~ diff_log_Unemployment + lag_diff_log_Unemployment + diff_log_AvgElectricityPrices + lag_diff_log_AvgElectricityPrices, data = final_ts_df)
