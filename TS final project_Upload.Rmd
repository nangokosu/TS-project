...
Electricty_avg=getSymbols('APU000072610',src='FRED',auto.assign=F)['1992-01-01/']
...
list_ts=list(cpi,ppi,energy,food,used_cars,govt_spending,personal_savings_rate,housing, Unemployment, Electricty_avg)
...
colnames(final_ts_df)=c("Date","CPI","PPI","Energy","Food","Used_cars","Govt_spending","Personal_savings","Housing_prices", "Unemployment_Rate", "AvgElectricityPrices")
colnames(final_xts)=c("CPI","PPI","Energy","Food","Used_cars","Govt_spending","Personal_savings","Housing_prices", "Unemployment_Rate", "AvgElectricityPrices")
```
...
acf(diff(log(final_ts_df$Unemployment_Rate)),main="ACF for Unemployment")
