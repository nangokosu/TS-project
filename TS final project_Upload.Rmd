...
```{r}
CPI_Unemployment_Electricity <- lm ( diff_log_CPI ~ diff_Unemployment + diff_log_AvgElectricityPrices , data = final_ts_df)
...
lag_CPI_Unemployment_AvgElectricityPrices <- lm ( diff_log_CPI ~ diff_Unemployment + diff_log_AvgElectricityPrices + lag_4_diff_log_AvgElectricityPrices, data = final_ts_df)
...
```{r}
PPI_Unemployment_Electricity <- lm ( diff_log_PPI ~ diff_Unemployment + diff_log_AvgElectricityPrices , data = final_ts_df)

summary(PPI_Unemployment_Electricity)

plot(PPI_Unemployment_Electricity)
...
lag_PPI_Unemployment_AvgElectricityPrices <- lm ( diff_log_PPI ~ diff_Unemployment + diff_log_AvgElectricityPrices + lag_4_diff_log_AvgElectricityPrices, data = final_ts_df)
